    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="分店名称" prop="name">
                              <el-input v-model="ruleForm.name"
                                        placeholder="分店名称" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="分店名称" prop="name">
                                  <el-input v-model="ruleForm.name"
                                            placeholder="分店名称" readonly></el-input>
                              </el-form-item>
                          </div>
                      </el-col>
                   <el-col :span="24">
                       <el-form-item class="upload" v-if="type!='info' && !ro.imgPhoto" label="分店图片" prop="imgPhoto">
                           <file-upload
                                   tip="点击上传分店图片"
                                   action="file/upload"
                                   :limit="3"
                       ...
                       <div v-else>
                           <el-form-item v-if="ruleForm.imgPhoto" label="分店图片" prop="imgPhoto">
                               <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.imgPhoto.split(',')" :src="item" width="100" height="100">
                           </el-form-item>
                       </div>
                   </el-col>
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="分店地址" prop="dizhi">
                              <el-input v-model="ruleForm.dizhi"
                                        placeholder="分店地址" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="分店地址" prop="dizhi">
                                  <el-input v-model="ruleForm.dizhi"
                                            placeholder="分店地址" readonly></el-input>
                              </el-form-item>
                          </div>
                      </el-col>
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="店长" prop="dianzhang">
                              <el-input v-model="ruleForm.dianzhang"
                                        placeholder="店长" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="店长" prop="dianzhang">
                                  <el-input v-model="ruleForm.dianzhang"
                                            placeholder="店长" readonly></el-input>
                              </el-form-item>
                          </div>
                      </el-col>
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="电话" prop="phoen">
                              <el-input v-model="ruleForm.phoen"
                                        placeholder="电话" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="电话" prop="phoen">
                                  <el-input v-model="ruleForm.phoen"
        ...
        data() {
            ...
            return {
                ...
                rules: {
                        ...
                        imgPhoto: [
                        { required: true, message: '分店图片不能为空', trigger: 'blur' },
                    ],

                        dizhi: [
                        { required: true, message: '分店地址不能为空', trigger: 'blur' },
                    ],
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                                 ...
                                 if(o=='dianzhang'){
                                     this.ruleForm.dianzhang = obj[o];
                                     this.ro.dianzhang = true;
                                     continue;
                                 }
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url: `fendian/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
